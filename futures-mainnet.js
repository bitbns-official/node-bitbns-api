...
bitbns.futuresWalletBalance({network: 'mainnet'},function(error, data) {
	console.log(data);
...
// // Get all open orders
bitbns.futuresOpenOrders({network: 'mainnet'},function(error, data) {
	console.log(data);
});


// // // Get all open positions
bitbns.futuresOpenPositions({network: 'mainnet'},function(error, data) {
	console.log(data);
});
