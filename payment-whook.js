...
let stringToEncode = "description=" + (description) + "&upi_id=" + upi_id + "&source=" + source + "&bitbns_ref=" + ref_no_bitbns + "&amount=" + amount + "&merchant_id=" + merchant_id + "&reference_number=" + reference_number + "&user_identifier=" + user_identifier + "&ack_type=" + ack_type;
...
source - last 2 digits of bank account
